        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <select class="form-control" name="type_document" id="edit_type_document">
                        <option selected id="type_document_val"></option>
                        <option value="DNI">DNI</option>
                        <option value="Cedula">Cédula</option>
                      </select>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9"> 
                      <div class="date">
                        <input type="text" class="form-control" id="datepicker_edit_1" name="document_expiration_date">
                      </div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="edit_inter_bank_code" name="inter_bank_code">
                      </div>
                  </div>
                  <div class="form-group">
                      <label for="pension_plan" class="col-sm-3 control-label">Plan de pensiones</label>
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="edit_pension_plan" name="pension_plan">
                      </div>
                  </div>
                  <div class="form-group">
                      <label for="health_insurance" class="col-sm-3 control-label">Seguro de salud</label>
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="edit_health_insurance" name="health_insurance">
                      </div>
                  </div>
                </fieldset>
                <fieldset>
