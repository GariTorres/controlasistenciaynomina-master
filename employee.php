...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#type_document_val').val(response.type_document).html(response.type_document);
      $('#edit_document_number').val(response.document_number);
      $('#datepicker_edit_1').val(response.document_expiration_date);
      $('#gender_val').val(response.gender).html(response.gender);
      $('#edit_shift').val(response.shift);
      $('#edit_salary').val(response.salary);
      $('#position_val').val(response.position_id).html(response.description);
      $('#edit_bank').val(response.bank);
      $('#edit_account_number').val(response.account_number);
      $('#edit_inter_bank_code').val(response.inter_bank_code);
      $('#edit_pension_plan').val(response.pension_plan);
      $('#edit_health_insurance').val(response.health_insurance);
    }
  });
}
</script>
